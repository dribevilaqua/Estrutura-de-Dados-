...
// Criando um vetor com números misturados de 0 a 1000
let vetor = Array.from({ length: 1000 }, () => Math.floor(Math.random() * 1001));

////testando tempo de cada função em um vetor com números misturados de 1000 números
// Cópia separada do vetor vetorord original
let vetor1 = vetor.splice()
let vetor2 = vetor.splice()
